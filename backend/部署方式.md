...
# 啟動容器
cd /data/paul.fc.tsai_data/realtime-dialogue-bot && podman run -d -p 8945:8000 --gpus all -v ./backend:/app:z  -e LD_LIBRARY_PATH="/usr/local/lib/python3.10/dist-packages/nvidia/cudnn/lib:/usr/local/lib/python3.10/dist-packages/ctranslate2.libs:/usr/local/nvidia/lib:/usr/local/nvidia/lib64" -e FIPS_MODE=0 -e OPENSSL_FIPS=0 -e LIBCRYPTO_FIPS=0 --name realtime-dialogue-backend realtime-dialogue-backend
